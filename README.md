...
| ------------------- | ----------------- | ----------------- | ----------------- | ----------------- | ------------------ | ----------------- |
| RPMNet              | 30.898 ± 0.322    | **0.002 ± 0.000** | 0.153 ± 0.001     | ++0.998 ± 0.000++ | 0.094 ± 0.001      | ++0.021 ± 0.000++ |
| Predator            | 7.262 ± 0.555     | 0.028 ± 0.002     | ++0.045 ± 0.002++ | **1.000 ± 0.000** | ++0.026 ± 0.001++  | 0.071 ± 0.001     |
| GeoTransformer      | 50.357 ± 1.238    | 0.215 ± 0.003     | 0.255 ± 0.005     | 0.921 ± 0.001     | 0.101 ± 0.002      | 0.065 ± 0.000     |
| RegTR               | **1.712 ± 0.061** | ++0.007 ± 0.000++ | **0.017 ± 0.000** | **1.000 ± 0.000** | **0.009 ± 0.000**  | 0.045 ± 0.000     |
| LoGDesc             | 42.762 ± 1.254    | 0.158 ± 0.003     | 0.183 ± 0.004     | 0.978 ± 0.001     | 0.097 ± 0.002      | 0.075 ± 0.000     |
| **R3PM-Net (ours)** | ++5.198 ± 0.067++ | 0.010 ± 0.000     | 0.052 ± 0.000     | **1.000 ± 0.000** | 0.029 ± 0.000      | **0.007 ± 0.000** |
...
| Method              | RRE [°] ↓         | RTE [cm] ↓        | CD [cm] ↓         | Fitness ↑         | Inlier RMSE [cm] ↓ | Time [s] ↓        |
| ------------------- | ----------------- | ----------------- | ----------------- | ----------------- | ------------------ | ----------------- |
| RPMNet              | 32.217 ± 0.844    | **0.002 ± 0.000** | 0.160 ± 0.004     | ++0.997 ± 0.002++ | 0.098 ± 0.001      | 0.021 ± 0.000     |
| Predator            | 16.448 ± 1.548    | 0.044 ± 0.003     | 0.072 ± 0.002     | **1.000 ± 0.000** | 0.042 ± 0.001      | 0.071 ± 0.001     |
| GeoTrans.           | 45.582 ± 0.549    | 0.183 ± 0.005     | 0.297 ± 0.007     | 0.906 ± 0.004     | 0.111 ± 0.002      | 0.065 ± 0.000     |
| RegTR               | **1.311 ± 0.032** | ++0.004 ± 0.000++ | **0.023 ± 0.000** | **1.000 ± 0.000** | **0.012 ± 0.000**  | 0.045 ± 0.000     |
| LoGDesc             | 121.224 ± 10.396  | 0.773 ± 0.060     | 0.692 ± 0.022     | 0.718 ± 0.010     | 0.224 ± 0.002      | 0.075 ± 0.000     |
| **R3PM-Net (ours)** | ++5.451 ± 0.287++ | 0.006 ± 0.001     | ++0.054 ± 0.002++ | **1.000 ± 0.000** | ++0.030 ± 0.001++  | **0.006 ± 0.000** |
